...
namespace ProjetoDesafio.DAO
{
    public class EnderecoDAO
    {
        public static DataTable fb_GetDados()
        {
            using (FbConnection conexaoFirebird = Connection.getInstancia().getConexao())
            {
                try
                {
                    ...
                    string mSQL = "Select * from Endereco";
        ...
        public static void fb_InserirDados(Endereco endereco)
        {
            using (FbConnection conexaoFireBird = Connection.getInstancia().getConexao())
            {
                try
                {
                    conexaoFireBird.Open();
                    string mSQL = "INSERT into Endereco Values(" + endereco.idEndereco + ", " + endereco.cep + "," +
                                  endereco.rua + "," +

    ...
    public class FuncionarioDao
    {
        ...
        public static Model.FuncionarioModel Listar(int idFn)
        {
            var conexaoFireBird = Connection.GetInstancia().GetConexao();
            {
                ...
                {
                    conexaoFireBird.Open();
                    var mSql = @"SELECT *FROM Funcionario F INNER JOIN Pessoa AS P ON F.Id_Pessoa = P.Id_Pessoa
                                    INNER JOIN Endereco AS E ON P.Id_Endereco = E.Id_Endereco " + idFn;
                    var cmd = new FbCommand(mSql, conexaoFireBird);
                    ...
                    while (dr.Read())
                    {
                        ...
                        funcionario.Cargo = new CargoModel();
